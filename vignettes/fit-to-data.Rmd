...
if (FALSE) {
  ...
  fit <- mmmstan(
    ...
    year_released_end = year_released_end,
    step_interval = step_interval,
    step_liberty_max = step_liberty_max,
    terms_unique_movement = terms_unique_movement,
    nest_terms_within_times = nest_terms_within_times,
    ...
    mu_fishing_time_deviation = mu_fishing_time_deviation,
