...
if (fit_models) {
  ...
  tag_data <- tags_released %>%
    ...
    dplyr::select(
      ...
      size_released = released_length,
      region_released = released_region,
      omregion_released = released_omregion,
      date_recovered = recovered_date,
      region_recovered = recovered_region,
      omregion_recovered = recovered_omregion,
      source,
      days_liberty,
      tag_distance
    )
